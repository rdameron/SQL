/*
2017-10-08
SQL SATURDAY ORLANDO attendees: While preppping this script for upload I noticed it is probably time to update the SQL Server version checks in the script.
